...
<h2 class="post-title"><a href="{{ route('post.show',[app()->getLocale(),$groupSlugOrUserName,$post->slug]) }}">{{ $post->title }}</a></h2>
<div class="post-content">
	@if(\Route::currentRouteName()!='post.show' && $post->excerpt!=NULL)
		{!! $post->excerpt !!}
		@if($post->excerpt!=$post->html || $post->iframe_mode!=0)
		<div class="read-more"><a class=" btn btn-outline-primary btn-sm" href="{{ route('post.show',[app()->getLocale(),$groupSlugOrUserName,$post->slug]) }}">{{ __('post.Read more') }}</a></div>
		@endif
...
<span class="post-footer">
	...
	<a href="{{ route('post.show',[app()->getLocale(),$groupSlugOrUserName,$post->slug,'#comments']) }}"><span class="fa">&#xf086; {{ $post->comments_count }}</span></a>
</span>
<br><br>
<?php
	unset($plusActive);
